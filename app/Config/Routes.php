...
$routes->get('/register','Templating::coba');
...
$routes->get('/admin/posts/delete/(:any)', 'AdminPostsController::index');
$routes->delete('/admin/posts/delete/(:any)', 'AdminPostsController::delete/$1');
